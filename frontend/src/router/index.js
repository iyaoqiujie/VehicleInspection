    ...
    children: [
      {
        ...
        meta: { title: '检测点列表', icon: 'list' }
      },
      {
        path: 'createstation',
        name: 'CreateStation',
        component: () => import('@/views/station/CreateStation'),
        meta: { title: '新建检测点', icon: 'edit' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'vehiclelist',
        name: 'VehicleList',
        component: () => import('@/views/vehicle/VehicleList'),
        meta: { title: '机动车列表', icon: 'table' }
      }
    ]
  },
  {
