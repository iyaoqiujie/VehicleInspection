  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item label="检测点名称" prop="username">
          <el-input v-model="temp.name" />
        </el-form-item>
        <el-form-item label="检测点地址" prop="mobile">
          <el-input v-model="temp.address" />
        </el-form-item>
        <el-form-item label="联系人" prop="">
          <el-input v-model="temp.contact" />
        </el-form-item>
        <el-form-item label="联系电话" prop="company">
          <el-input v-model="temp.phone" />
        </el-form-item>
        <el-form-item label="管理员用户名" prop="mobile">
          <el-input v-model="temp.admin_username" readonly="readonly"/>
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [{ required: true, message: '需要填写名称', trigger: 'change' }],
        address: [{ required: true, message: '需要填写地址', trigger: 'change' }],
      },
